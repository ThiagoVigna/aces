		...
		<div class="card-body">
			<div class="row">
				...
				<div class="col-4 text-center">
					<a href="/"><img src="<?= base_url('public/images/icons-speech.png') ?>">
						<sub>
				...
				<div class="col-4 text-center">
					<a href="/"><img src="<?= base_url('public/images/icons-group.png') ?>">
						<sub>
							<span class="badge badge-pill badge-info badge-with-icon">123</span>
						</sub> <br>
				...
				<div class="col-4 text-center">
					<a href="/"><img src="<?= base_url('public/images/icons-staff.png') ?>">
						<sub>
							<span class="badge badge-pill badge-info badge-with-icon">123</span>
						</sub> <br>
