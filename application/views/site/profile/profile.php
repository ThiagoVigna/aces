...
<div class="container-fluid">
	...
	<div class="row mb-3">
		<div class="col-lg-4">
			<div class="card mb-3">
				<div class="card-body text-center shadow"><img class="rounded-circle mb-3 mt-4" src="<?= base_url('public/images/foto.jpg')?>" width="160" height="160">
			...
			<div class="card shadow mb-4">
				...
				<div class="card-body">
					...
					<div class="progress progress-sm mb-3 cc_cursor">
